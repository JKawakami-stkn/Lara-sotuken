...
@section('content')
    ...
    <div class="main">
        <div class="container">
            ...
            <a id="1_1" onclick="createModal(this.id);">てすと</a>
                ...
                <div class="z-depth-1 blue-text order">
                    ...
                    <div class="row">
                      ...
                      <div class="col s4 order_button">
                            ...
                            <a class="btn-floating btnz-large waves-effect waves-light red"
                    ...
                    @foreach($hannbaikumi as $kumidata)
                        <span>
                            <a class="modal-trigger" href="#{{$hannbaikaidata->hannbaikai_name}}">
            ...
            <div id="{{$hannbaikaidata->hannbaikai_name}}" class="modal">
                <div class="modal-content">
                    <div class="modal-header center-align">
                        <h5>発注書〇</h5>
                    </div>

                    <a id="fill_in" href="{{ action('PoFillInController@show') }}">
                        <div class="row">
                            <div class="card">
                    ...
                    <a id="customer_list" href="{{ action('PoFillInController@show') }}">
                        <div class="row">
                            <div class="card">
                                <div class="card-content center-align">
                                    <p>注文内容確認</p>
                    ...
                    <a id="check_delivery" href="{{ action('PoFillInController@show') }}">
                        <div class="row">
                            <div class="card">
                                <div class="card-content center-align">
                                    <p>引き渡しチェック</p>
